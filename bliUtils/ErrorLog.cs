...
namespace bliUtils
{
    public sealed class ErrorLog
    {
        ...
        public ErrorLog()
        {
            _LogPath = Path.Combine(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "BlitzChat"), "Errors");
        ...
        public string LogError(Exception exception)
        {
            ...
            string LogFile = "CrashReport_"+DateTime.Now.ToString("yyyy-MM-dd_HH.mm.ss") + ".txt";
